...
public class GitLocalRestClient {
    ...
    public String getAllRepo() throws IOException, GitAPIException {
        ...
        /* The above link should be pointing to the Repository of your choice. I have downloaded the git repo in my local repo
        * and to get the direct link for some online required the credidetial and security associated with it and hence I have not gone to pick online repository
        * */
